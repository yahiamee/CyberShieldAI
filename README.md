...
## 🤝 المساهمة
الطلبات مرحب بها. افتح Issue لوصف المشكلة أو اقترح تحسيناً، ثم أرسل Pull Request مع وصف مختصر للتغييرات وخطوات التحقق.

## 📄 الترخيص
حدّد نوع الترخيص المناسب (MIT، Apache-2.0، إلخ) ثم حدّث هذه الفقرة وفقاً للقرار النهائي.
